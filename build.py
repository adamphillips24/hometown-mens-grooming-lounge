...
<header class="site-header"><div class="wrap header-inner"><a class="wordmark" href="#top" aria-label="Hometown Men's Grooming Lounge home">HOMETOWN<small>MEN’S GROOMING LOUNGE</small></a><nav class="nav" aria-label="Main navigation"><a href="#barbers">Barbers</a><a href="#services">Services</a><a href="#visit">Visit</a><a class="nav-book" href="#barbers">Book a chair</a></nav></div></header>
<main id="main">
...
<section class="closing" aria-labelledby="closing-title"><div class="wrap"><p class="eyebrow">Ready when you are</p><h2 id="closing-title">Grab the chair.</h2>{pair('footer')}</div></section>
</main>
